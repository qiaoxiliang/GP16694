...
public class FlieUpLoadTemplate {
    ...
    public final int fileUpload(UploadCallBack callBack){
        ...
        try {
            ...
            List<String> rowList = callBack.getRowList();
            ...
            // 是否需要发送邮件
            if(callBack.needSendMail(false)){
